...
\lstdefinelanguage{haskell}{
  morekeywords={class,instance,signature,where,do,data,newtype,default,deriving,module,type,case,of,pattern,family},
  otherkeywords={<-,->,=,|,::},
  sensitive=true,
  morecomment=[l]{--},
  morecomment=[n]{\{-}{-\}}, 
...
\logo{\includegraphics[height=0.8cm]{image/CSIRO-Data61-brand.png}}
